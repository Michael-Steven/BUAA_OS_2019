...
static Pte *boot_pgdir_walk(Pde *pgdir, u_long va, int create)
{
     ...
     * entry value. */
	pgdir_entryp = PDX(va) + pgdir;  						// calculate the correspoding page directory entry
	pgtable = (Pte *)KADDR(PTE_ADDR(*pgdir_entryp));		// use PTE_ADDR to clean the tags of page directory entry
